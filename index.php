	...
	<div id="main">
		<div id="content">
			...
			<?php
				...
				echo('<div class="barBorder" id="indexBar"><div class="bar" style="width:98%">
					<h5 class="bar">'. $totalTid. ' timmar av 100 arbetat.</h5>
					</div></div>');
				...
				foreach ($antalsVal as $val){
					echo '<td style="padding:0.7em"> <a href="http://luckey.se/blag/index.php?
				...
				if($start > 3){
					echo '<td style="padding:0.5em"> <a href="http://luckey.se/blag/index.php?antal='. $antal. '&sida=1"><<</a></td>';
				}
				for($i = 1; $i < ($count / $antal + 1); $i++){
					if($i == ($start + 1)){
						...
						echo '<td style="padding:0.5em"> <a href="http://luckey.se/blag/index.php
							?antal='. $antal. '&sida='. $i. '"> '. $i. ' </a></td>';
					}
				}
				if($start < ($count - 4)){
					echo '<td style="padding:0.5em"> <a href="http://luckey.se/blag/index.php?antal='. $antal. '&sida='. $count. '">>></a></td>';
				}
				echo '</table><br /><br /><br />';
				?>
			</div>
